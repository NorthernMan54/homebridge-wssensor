// Homebridge platform plugin supporting NODEMCU based sensor devices.
// Featuring sensor discovery via MDNS and realtime updates via mDNS
//
...
module.exports = function(homebridge) {
    ...
    homebridge.registerPlatform("homebridge-wssensor", "wssensor", wssensor);
}
...
wssensor.prototype.configureAccessory = function(accessory) {
    var self = this;
...
wssensor.prototype.didFinishLaunching = function() {
    var self = this;
    ...
    try {
        ...
        browser.on('serviceUp', function(service) {
            ...
            //            for (var i = 0; i < 5; i++) {
            wssensor.prototype.mcuModel("http://" + service.host + ":" + service.port + "/", function(err, model) {
                if (!err) {
                    //                        i = 5;
...
wssensor.prototype.devicePolling = function() {
...
wssensor.prototype.Identify = function(accessory, status, callback, that) {
...
wssensor.prototype.resetDevices = function(accessory, status, callback) {
    var self = this;
    ...
    if (status == "1") {
        ...
        for (var id in self.accessories) {
            ...
            wssensor.prototype.Identify(device, status, function(err, status) {
...
wssensor.prototype.setTargetDoorState = function(accessory, status, callback) {
    var self = this;
...
wssensor.prototype.getDHTTemperature = function(accessory, callback) {
    var self = this;
